...
public class ExThreadsMain implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        // ExThreadsMain クラスのインスタンスを作成します。
        ExThreadsMain ct1 = new ExThreadsMain(); // CountTenBクラスのインスタンスとして
        ExThreadsMain ct2 = new ExThreadsMain(); // CountTenBクラスのインスタンスとして
        ...
        // スレッドを開始します。これにより、ExThreadsMain の run メソッドが呼び出されます。
        th1.start();
        th2.start();
